...
require_file "$public_dir/README.md"
require_file "$public_dir/README.en.md"
require_file "$public_dir/LICENSE"
...
install -m 0644 "$public_dir/README.en.md" "$root/README.en.md"
